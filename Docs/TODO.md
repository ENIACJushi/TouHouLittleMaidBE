...
+ 农作模式不再需要生物破坏；
+ 农作模式支持更多的作物（详见更新细节）；
+ 禁用生物破坏的拾物模式：每3秒捡起周围所有物品；
+ 去除背包实体，在跳水等场景不会掉包了；
+ 阵亡时产生墓碑，收回时直接爆出物品，不再产生箱子；
+ 收回/阵亡时背包大小会被记录，再生时不需要重新换包；
+ 坐下状态也能捡东西了；
+ 取消女仆箱子必须由主人打开的要求（女仆箱子将在下个版本被移除，请尽快取出世界中残留箱子内的物品）；

#### 更新细节

农作模式支持的作物

- 原版：萝卜、小麦、甜菜、土豆、地狱疣、火把花、猪笼草
- 农夫乐事：洋葱、卷心菜、番茄、稻米
- 玉米乐事：玉米
