...
{ type: "text", content:
  ...
  感谢酒石酸菌和雪尼等人制作的java版TouhouLittleMaid。 
...
`
§l自定义坐垫§r
  自定义坐垫是纯装饰向的物品，右击方块放置。潜行左击能够打掉它。右击能够坐上，潜行右击可以打开切换坐垫样式的界面。

$recipe$`
},
{ type: "text", content:
`
  坐垫模型可以完全自定义，也可通过资源包快捷添加自定义模型。
`
},
{ type: "craft", recipe: "chair_show.json", content:
`
§l坐垫显示器§r
  潜行时手持此物品，附近的坐垫会显示碰撞箱。
