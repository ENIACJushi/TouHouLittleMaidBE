import { Direction, Block, BlockPermutation, Dimension, ItemUseOnBeforeEvent, DataDrivenEntityTriggerAfterEvent, Entity, ItemStack } from "@minecraft/server";
...
export class GoldMicrowaver{
    ...
    static recipes = [
        undefined, // 空气占位
        // {"material": "minecraft:apple", "result": "minecraft:bone", "time": 10 }, // 测试用
        ...
        // 空闲状态/工作暂停
            ...
            if(this.Entity.getDoor(waver)){
                ...
                // State 010 0 | 开门无物品
                    ...
                    let item = getPlayerMainHand(player);
                    if(player.isSneaking || item === undefined){
                        // 潜行总是关门
                        this.Entity.setDoor(waver, false);
                        this.Block.setDoor(waverBlock, false);
                    }
    ...
    */
     static finishEvent(event){
        ...
        let waverBlock = waver.dimension.getBlock(waver.location);
