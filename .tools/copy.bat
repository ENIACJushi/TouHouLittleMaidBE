...
rmdir /s /q "%MinecraftPath%\development_resource_packs\TouHouLittleMaid_PBR"
xcopy /I /Q /s /e "..\TouHouLittleMaid_PBR" "%MinecraftPath%\development_resource_packs\TouHouLittleMaid_PBR"
