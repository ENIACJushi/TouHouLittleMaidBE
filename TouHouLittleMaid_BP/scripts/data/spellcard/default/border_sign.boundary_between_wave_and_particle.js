            ...
            var shoot_basic = function ($times) {
                for (var j = 0; j < 9; j++) {
                    ...
                    var danmaku = new Danmaku(shooter.dimension, shooter).setDamage(2)
                        .setDanmakuType(Type.PETAL).setColor(Color.MAGENTA).setThrowerLocation(new Vector(shooter.location.x, shooter.location.y + 1, shooter.location.z));
...
//# sourceMappingURL=border_sign.boundary_between_wave_and_particle.js.map