...
export class AltarStructureHelper extends MultiBlockStructrueManager {
    constructor() {
        super([8, 6, 8], undefined, // [{name:"minecraft:air", data: null}],
        [
    ...
    popItem(itemEntity) {
        ...
        itemEntity.applyImpulse(new Vector(drectionX * Tool.getRandom(0.1, 0.2), Tool.getRandom(0.3, 0.4), drectionZ * Tool.getRandom(0.1, 0.2)));
    }
    /**
     *
     * @param {Entity} entity
...
//# sourceMappingURL=AltarStructureHelper.js.map