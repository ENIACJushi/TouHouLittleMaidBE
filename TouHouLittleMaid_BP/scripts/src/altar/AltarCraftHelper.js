            ...
            switch (output.type) {
                ...
                case "touhou_little_maid:maid_upgrade":
                    ...
                    if (EntityMaid.Kill.get(target) < output["kills"]) {
                        Tool.title_player_actionbar_object(player.name, { "rawtext": [{ "translate": "message.touhou_little_maid.altar.upgrade.kill" },
...
//# sourceMappingURL=AltarCraftHelper.js.map