...
if (false) {
    ...
    world.afterEvents.entityHurt.subscribe(event => {
        var _a, _b, _c;
        //// 伤害信息 ////
        Tool.logger(` ${(_c = (_b = (_a = event === null || event === void 0 ? void 0 : event.damageSource) === null || _a === void 0 ? void 0 : _a.damagingEntity) === null || _b === void 0 ? void 0 : _b.typeId) !== null && _c !== void 0 ? _c : '?'} -> ${event.hurtEntity.typeId}: ${event.damage.toFixed(2)}`);
        //// 伤害统计 ////
        if (event.damage < 0)
            return; // 排除治疗
        count++;
