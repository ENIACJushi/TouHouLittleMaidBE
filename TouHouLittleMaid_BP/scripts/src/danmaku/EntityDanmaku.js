...
export class EntityDanmaku {
    ...
    shoot_bedrock(velocity, inaccuracy) {
        ...
        if (this.enableThrowerLocation) {
            ...
            spawn_location = new Vector(s.x + this.thrower_offset.x, s.y + this.thrower_offset.y, s.z + this.thrower_offset.z);
        }
        // Get type
        let type = this.type == DanmakuType.RANDOM ? DanmakuType.random() : this.type;
        // Spawn entity
        let danmaku = this.world.spawnEntity(DanmakuType.getEntityName(type), spawn_location);
        // Set color
        ...
        if (this.ownerID !== undefined) {
            danmaku.setDynamicProperty("owner", this.ownerID);
        }
        // Set velocity
...
//# sourceMappingURL=EntityDanmaku.js.map